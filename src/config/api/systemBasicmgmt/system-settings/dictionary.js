...
export const GET_DICTIONARY_ENTITY_API = {
    GET_DICTIONARY_ENTITY: 'SystemBasicMgmt/SystemSettings/DictionaryInfo/GetDictionaryInfoEntity'
}

// 字典分页API
export const GET_DICTIONARY_PAGES_API = {
  GET_DICTIONARY_PAGES: 'SystemBasicMgmt/SystemSettings/DictionaryInfo/GetDictionaryInfoPage'
}

// 新增字典API
export const INSERT_DICTIONARY_API = {
  INSERT_DICTIONARY: 'SystemBasicMgmt/SystemSettings/DictionaryInfo/InsertDictionaryInfo'
}

// 更新字典API
export const UPDATE_DICTIONARY_API = {
  UPDATE_DICTIONARY: 'SystemBasicMgmt/SystemSettings/DictionaryInfo/UpdateDictionaryInfo'
}
