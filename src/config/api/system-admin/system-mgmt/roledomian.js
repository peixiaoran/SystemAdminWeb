...
export const UPDATE_ROLE_DOMAIN_API = {
  UPDATE_ROLE_DOMAIN: 'SysBasic/SysManagement/RoleDomainControllers/UpdateRoleDomain'
}

// 获取角色网域列表API
export const GET_ROLE_DOMAIN_API = {
  GET_ROLE_DOMAIN: 'SysBasic/SysManagement/RoleDomainControllers/GetRoleDomainList'
}

// 获取角色下拉列表API
export const GET_ROLE_DROPDOWN_API = {
  GET_ROLE_DROPDOWN: 'SysBasic/SysManagement/RoleDomainControllers/GetRoleDropDown'
}