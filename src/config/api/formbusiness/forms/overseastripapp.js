...
// 初始化出差申请单API
export const INIT_OVERSEASTRIPAPP_API = 'FormBusiness/Forms/OverseasTripApp/InitOverseasTripApp'
...
// 暂存出差申请单API
export const SAVE_OVERSEASTRIPAPP_API = 'FormBusiness/Forms/OverseasTripApp/SaveOverseasTripApp'
...
// 送审出差申请单API
export const APPROVE_OVERSEASTRIPAPP_API = 'FormBusiness/Forms/PublicForm/FromApprove'

// 驳回出差申请单API
export const REJECT_OVERSEASTRIPAPP_API = 'FormBusiness/Forms/PublicForm/FromReject'
