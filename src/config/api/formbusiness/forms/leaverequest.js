...
// 初始化请假单 API
export const INIT_LEAVEREQUEST_API = 'FormBusiness/Forms/LeaveRequest/InitLeaveRequest'

// 保存请假单API
export const SAVE_LEAVEREQUEST_API = 'FormBusiness/Forms/LeaveRequest/SaveLeaveRequest'

// 获取请假单详情API
export const GET_LEAVEREQUEST_DETAIL_API = 'FormBusiness/Forms/LeaveRequest/GetLeaveRequest'

// 获取请假类型下拉框API
export const GET_LEAVEREQUEST_DROPDOWN_API = 'FormBusiness/Forms/LeaveRequest/GetLeaveTypeDrop'
...
// 获取可代理用户信息API
export const GET_AGENT_USER_INFO_API = 'FormBusiness/Forms/LeaveRequest/GetUserInfoAgentView'
...
// 送审请假单API
export const APPROVE_LEAVEREQUEST_API = 'FormBusiness/Forms/PublicForm/FromApprove'

// 驳回请假单API
export const REJECT_LEAVEREQUEST_API = 'FormBusiness/Forms/PublicForm/FromReject'
