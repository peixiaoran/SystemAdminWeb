export default {
  ...
  formbusiness: {
    ...
    pendingreview: {
      ...
      getFailed: '获取待审批列表失败',
      viewPendingReviewers: '查看待审批人',
      pendingReviewersTitle: '待审批人',
      stepName: '流程步骤',
      reviewerUserName: '待审批人姓名',
      appointmentType: '审批身份',
      agentUserName: '代理人姓名',
      getPendingReviewersFailed: '获取待审批人失败',
      noPendingReviewers: '暂无待审批人'
    },
