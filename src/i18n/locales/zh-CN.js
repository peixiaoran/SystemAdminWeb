export default {
  ...
  formbusiness: {
    ...
    leavecancell: {
        ...
        viewRemainingCancellHours: '可销时数',
        remainingCancellHoursTitle: '本单可销假时数',
        remainingCancellHoursValue: '{hours} 小时',
        remainingCancellHoursEmpty: '暂无数据',
        getRemainingCancellHoursFailed: '获取可销假时数失败',
