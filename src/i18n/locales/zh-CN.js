export default {
  ...
  systemBasicmgmt: {
    ...
    userPosition: {
      ...
      positionNameChPlaceholder: '请输入职位中文名称',
    ...
    systemMgmt: {
      ...
      domain: {
        ...
        pleaseInputDomainNameCh: '请输入网域中文名称',
      ...
      module: {
        ...
        pleaseInputMenuNameCh: '请输入模块中文名称',
      ...
      program: {
        ...
        pleaseInputProgramNameCh: '请输入程序中文名称',
    ...
    departmentLevel: {
      ...
      pleaseInputDepartmentLevelNameCh: '请输入级别中文名称',
