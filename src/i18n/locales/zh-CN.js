export default {
  ...
  formbusiness: {
    ...
    formtype: {
        ...
        pleaseInputApprovalPath: '请输入审批路径',
    ...
    workflowstep: {
      ...
      approveMode: '签核方式',
      pleaseSelectApproveMode: '请选择签核方式',
      ...
      operation: '操作',
      editBranch: '编辑分支',
      getBranchEntityFailed: '获取分支信息失败',
      editBranchSuccess: '编辑分支成功',
      editBranchFailed: '编辑分支失败',
      pleaseSelectCondition: '请选择条件',
      pleaseSelectNextStep: '请选择下一步骤',
      conditionOptionDefault: '默认',
      nextStepOptionEnd: '结束',
      addBranch: '新增分支',
      addBranchSuccess: '新增分支成功',
      addBranchFailed: '新增分支失败',
      branchDropdownLoadFailed: '加载分支下拉选项失败',
      deleteBranch: '删除分支',
      deleteBranchConfirm: '确定删除该分支吗？（{name}）',
      deleteBranchSuccess: '删除分支成功',
      deleteBranchFailed: '删除分支失败',
      branchRowIdMissing: '分支编号缺失，无法操作'
    },
    ...
    workflowcondition: {
      ...
      formTypeName: '表单类别',
      index: '序号',
      conditionNameCn: '条件名称(中)',
      conditionNameEn: '条件名称(英)',
      handlerKey: '处理键值',
      description: '描述',
      addCondition: '新增条件',
      editCondition: '编辑条件',
      pleaseInputConditionNameCn: '请输入条件中文名称',
      pleaseInputConditionNameEn: '请输入条件英文名称',
      ...
      editFailed: '编辑失败',
      deleteCondition: '删除',
      deleteConfirm: '确定要删除该条件吗？',
      deleteSuccess: '删除成功',
      deleteFailed: '删除失败',
      getEntityFailed: '获取条件详情失败',
      getFailed: '获取流程条件列表失败',
      getFormGroupFailed: '获取表单组别失败',
      getFormTypeFailed: '获取表单类别失败'
    },
    ...
    pendingsubapp: {
      ...
      getPendingSubAppFailed: '获取待签核列表失败',
      getFailed: '获取待审批列表失败'
    },
