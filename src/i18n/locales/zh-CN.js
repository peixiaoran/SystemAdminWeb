export default {
  ...
  SystemBasicMgmt: {
    ...
    userPartTime: {
      ...
      pleaseSelectPartTimePosition: '请选择兼任职位',
      pleaseSelectPartTimeLabor: '请选择兼任劳务',
      pleaseSelectStartTime: '请选择开始时间',
      pleaseSelectEndTime: '请选择结束时间',
      pleaseSelectUser: '请选择用户',
      partTimeDepartmentRequired: '请选择兼任部门',
      partTimePositionRequired: '请选择兼任职位',
      partTimeLaborRequired: '请选择兼任劳务',
      ...
      getPositionFailed: '获取职位列表失败',
      getLaborFailed: '获取劳务列表失败',
