export default {
  ...
  SystemBasicMgmt: {
    ...
    role: {
      ...
      pleaseInputRoleNameCn: '请输入角色中文名称',
      pleaseInputRoleNameEn: '请输入角色英文名称',
    ...
    dictionaryInfo: {
      ...
      pleaseInputDicNameCn: '请输入字典中文名称',
      pleaseInputDicNameEn: '请输入字典英文名称',
    ...
    // 币别资讯管理
     currencyInfo: {
       ...
       pleaseInputCurrencyNameCn: '请输入币别中文名称',
    ...
    userLabor: {
      ...
      laborTypeCode: '用工类型编码',
      laborTypeNameCn: '中文名称',
      laborTypeNameEn: '英文名称',
      laborTypeDescribe: '用工类型描述',
      operation: '操作',
      addLabor: '新增用工',
      editLabor: '编辑用工',
      addUserLabor: '新增用工类型',
      editUserLabor: '编辑用工类型',
      deleteConfirm: '确定要删除该用工类型吗？',
      pleaseInputLaborName: '请输入用工名称',
      pleaseInputLaborNameCn: '请输入中文名称',
      pleaseInputLaborNameEn: '请输入英文名称',
      pleaseInputLaborDescription: '请输入用工描述',
      pleaseInputLaborTypeCode: '请输入用工类型编码',
      pleaseInputLaborTypeNameCn: '请输入中文名称',
      pleaseInputLaborTypeNameEn: '请输入英文名称',
      pleaseInputLaborTypeDescribe: '请输入用工类型描述',
      saveSuccess: '保存成功',
      updateSuccess: '更新成功',
      deleteSuccess: '删除成功',
      operationFailed: '操作失败',
