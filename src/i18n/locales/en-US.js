export default {
  ...
  formbusiness: {
    ...
    leaveform: {
      ...
      formTitle: 'User Leave Application',
      ...
      attachmentTipSick: 'Sick leave requires medical records or a hospital certificate',
      attachmentTipMarriage: 'Marriage leave requires a marriage certificate or related proof',
      ...
      workflowStatusUnsigned: 'Pending approval',
      workflowStatusUnderReview: 'In approval',
  ...
  systembasicmgmt: {
    ...
    userInfo: {
      ...
      noticeLanguage: 'Notification Language',
