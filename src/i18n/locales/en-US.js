export default {
  ...
  formbusiness: {
    ...
    workflowrule: {
      ...
      sortOrder: 'Sort',
      version: 'Version',
      effectiveStartTime: 'Start Time',
      effectiveEndTime: 'End Time',
      pleaseInputVersion: 'Please enter version',
      pleaseSelectEffectiveStartTime: 'Please select effective start time',
      pleaseSelectEffectiveEndTime: 'Please select effective end time',
      effectiveEndTimeEmptyHint: 'Leave blank for no expiration',
      unlimited: 'Unlimited',
      addRule: 'Add Rule',
      editRule: 'Edit Rule',
      deleteRule: 'Delete',
    ...
    leaverequest: {
      ...
      forbiddenResultEyebrow: 'Access Restricted',
