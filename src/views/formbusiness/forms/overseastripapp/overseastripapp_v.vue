        ...
        <el-row v-if="isStepFieldVisible('TripReason')" :gutter="16">
          <el-col :span="24">
            <el-form-item :label="t('formbusiness.overseastripapp.tripReason')" prop="tripReason">
              <KeywordHighlightField :value="form.tripReason" :keyword="searchKeyword" multiline :rows="4" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row v-if="isAnyStepFieldVisible(['StartDate', 'EndDate', 'Days'])" :gutter="16">
          <el-col v-if="isStepFieldVisible('StartDate')" :span="8">
            <el-form-item :label="t('formbusiness.overseastripapp.startDate')" prop="startDate">
              <KeywordHighlightField :value="form.startDate" :keyword="searchKeyword" :prefix-icon="Calendar" style="width: 100%;" />
            </el-form-item>
          </el-col>
          <el-col v-if="isStepFieldVisible('EndDate')" :span="8">
            <el-form-item :label="t('formbusiness.overseastripapp.endDate')" prop="endDate">
              <KeywordHighlightField :value="form.endDate" :keyword="searchKeyword" :prefix-icon="Calendar" style="width: 100%;" />
            </el-form-item>
          </el-col>
          <el-col v-if="isStepFieldVisible('Days')" :span="8">
            <el-form-item :label="t('formbusiness.overseastripapp.days')" prop="days">
              <KeywordHighlightField :value="form.days" :keyword="searchKeyword" />
            </el-form-item>
          </el-col>
        </el-row>
            ...
            <el-form-item :label="t('formbusiness.overseastripapp.attachments')">
              <div class="upload-section">
                <el-table :data="uploadedAttachments" border size="small" class="attachment-table">
                  ...
                  <el-table-column :label="t('formbusiness.overseastripapp.fileName')" min-width="200">
...
async function fetchFullReviewFlow () {
  ...
  try {
    ...
    showResultNotice(t('formbusiness.overseastripapp.workflowLoadFailed'), 'error')
  } finally {
...
function showForbiddenResult () {
  ...
  resultState.titleKey = 'formbusiness.overseastripapp.forbiddenViewTitle'
  resultState.subTitleKey = 'formbusiness.overseastripapp.forbiddenViewSubTitle'
}
...
function bindFormData (data) {
  Object.assign(form, {
    ...
    returnTravelName: data.returnTravelName || '',
