        ...
        <el-row v-if="isAnyStepFieldVisible(['Category', 'EstimatedDays'])" :gutter="16">
          ...
          <el-col v-if="isStepFieldVisible('EstimatedDays')" :span="8">
            <el-form-item :label="t('formbusiness.informationrequest.estimatedDays')" prop="estimatedDays">
              <el-input-number v-model="form.estimatedDays" :min="0" controls-position="right" :disabled="!isStepFieldEditable('EstimatedDays')" style="width: 100%;" />
            </el-form-item>
          </el-col>
        </el-row>
          ...
          <el-col :span="24">
            <el-form-item :label="t('formbusiness.informationrequest.rating')" prop="rating">
              <el-tooltip :content="t('formbusiness.informationrequest.ratingTooltip')" placement="top">
                <el-rate v-model="form.rating" show-text :texts="ratingTexts" :disabled="!isStepFieldEditable('Rating')" />
              </el-tooltip>
            </el-form-item>
          </el-col>
        </el-row>
...
const rules = computed(() => {
  ...
  return {
    category: requiredWhenEditable('Category', 'formbusiness.informationrequest.pleaseSelectCategory', 'change'),
...
function getFirstValidateErrorMessage (invalidFields) {
  ...
  return firstField?.[0]?.message || t('formbusiness.informationrequest.validateFailed')
}
