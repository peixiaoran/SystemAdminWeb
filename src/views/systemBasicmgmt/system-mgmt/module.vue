  ...
  <div class="conventional-table-container">
      <el-card class="conventional-card">
          ...
          <el-form :inline="true" :model="filters" class="conventional-filter-form" role="search" aria-label="搜索">
              <el-form-item :label="$t('systembasicmgmt.module.moduleCode')">
          <el-input v-model="filters.moduleCode" :placeholder="$t('systembasicmgmt.module.pleaseInputModuleCode')" style="width:170px" />
        </el-form-item>
        <el-form-item :label="$t('systembasicmgmt.module.moduleNameCn')">
          <el-input v-model="filters.moduleName" :placeholder="$t('systembasicmgmt.module.pleaseInputModuleNameCn')" style="width:200px" />
              </el-form-item>
      ...
      <el-dialog v-model="dialogVisible"
          ...
          <el-input v-model="editForm.moduleNameCn" style="width:100%" />
              ...
              <div class="form-row full-width">
                  <el-form-item :label="$t('systembasicmgmt.module.remarksCh')" prop="remarksCh">
                      <el-input v-model="editForm.remarksCh" style="width:100%" type="textarea" :rows="2" />
                  </el-form-item>
              </div>
              <div class="form-row full-width">
                <el-form-item :label="$t('systembasicmgmt.module.remarksEn')" prop="remarksEn">
