    ...
    <el-card class="conventional-card">
      ...
      <div class="table-container">
        ...
        >
          ...
          <el-table-column prop="userNo" :label="$t('systembasicmgmt.userformbind.userNo')" align="center" min-width="150" />
          <el-table-column prop="userName" :label="$t('systembasicmgmt.userformbind.userName')" align="left" min-width="180" />
          <el-table-column prop="departmentName" :label="$t('systembasicmgmt.userformbind.departmentName')" align="left" min-width="230" />
          <el-table-column prop="positionName" :label="$t('systembasicmgmt.userformbind.positionName')" align="left" min-width="120" />
          <el-table-column prop="laborName" :label="$t('systembasicmgmt.userformbind.laborName')" align="center" min-width="270" />
